...
class RankDocList extends StatelessWidget {
  final List<DocumentSnapshot> docList;
  final String qsType;
  final Widget title;

  RankDocList({@required this.docList, @required this.qsType, @required this.title});
                      ...
                      children: <Widget>[
                        ...
                        Align(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              '주제: ' +
                                  cutBracket(docList[index].data['주제']
                                      .toString()),
                              overflow: TextOverflow.ellipsis,
                              maxLines: 1,
                              textAlign: TextAlign.left,
